...
import "@workspace/ui/smart-esim.css";
...
export default async function RootLayout({
  ...
  const { support, chat, appLink } = await getAppSettings();
  ...
  return (
    <html lang="en" suppressHydrationWarning dir={direction}>
      ...
      <body
        className={`$ ${poppins.variable}  relative bg-background font-poppins text-lg font-400`}
      >
        <NextIntlClientProvider>
                ...
                <ReduxProvider>
                  <ThemeProvider>
                    <ReactQueryProvider>
                      ...
                      {children}
                      <CartDetailSheet />
                      <Footer support={support} appLink={appLink} />
                    </ReactQueryProvider>
                    <Suspense>
                      <FloatingBottomNav />
                    </Suspense>
          ...
          <ChatSupportDialog whatsappNumber={support.phone} chat={chat} />
        </NextIntlClientProvider>
      </body>
      {/* </Suspense> */}
    </html>
