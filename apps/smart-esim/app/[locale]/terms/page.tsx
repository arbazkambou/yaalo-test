...
import { baseUrl, PageParams, termsOfServicePath } from "@/constants/constants";
...
export async function generateMetadata({
  ...
  return generateDynamicSeo({
    ...
    locale,
    url: `${baseUrl}${termsOfServicePath}`,
  });
}
...
async function Page({ params }: PageProps) {
  ...
  const t = await getTranslations("TermsPage.terms");
  ...
  return (
    <>
      <CountryRegionsHero heading={t("heading")} enableSearchList={false} />
