...
async function ActivevatedPackages({
  activatedPackages,
}: {
  activatedPackages: LastBundle[];
}) {
  const t = await getTranslations("simDetailPage.activatedPackages");
  return (
    <section className="mt-16">
      ...
      <div className="mt-8 grid gap-10 xl:grid-cols-2 xl:gap-20">
        {activatedPackages.map((item, index) => (
          <Card
...
export default ActivevatedPackages;
