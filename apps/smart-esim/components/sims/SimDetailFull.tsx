...
function SimDetailFull({
  ...
  const t = useTranslations("simDetailPage");
    ...
    <Card className="flex flex-col gap-[1rem] rounded-[1.8125rem] px-[0.88rem] py-[1.81rem]">
      ...
      <div className="flex flex-col gap-1 rounded-[0.5625rem] bg-muted px-[0.81rem] py-[0.69rem] md:flex-row md:justify-between">
        <div className="flex items-center gap-[0.81rem]">
          ...
          <p className="text-base font-500">SMDP + {t("address")}</p>
        </div>
      ...
      {number && (
        <div className="flex flex-col gap-1 rounded-[0.5625rem] bg-muted px-[0.81rem] py-[0.69rem] md:flex-row md:justify-between">
          <div className="flex items-center gap-[0.81rem]">
            ...
            <p className="text-base font-500">{t("number")}</p>
          </div>
          <div className="flex items-center gap-[0.88rem]">
      ...
      <div className="flex flex-col gap-1 rounded-[0.5625rem] bg-muted px-[0.81rem] py-[0.69rem] md:flex-row md:justify-between">
        <div className="flex items-center gap-[0.81rem]">
          ...
          <p className="text-base font-500">{t("purchaseData")}</p>
        </div>
      ...
      <div className="flex flex-col gap-1 rounded-[0.5625rem] bg-muted px-[0.81rem] py-[0.69rem] md:flex-row md:justify-between">
        <div className="flex items-center gap-[0.81rem]">
          ...
          <p className="text-base font-500">{t("coverage")}</p>
        </div>
        <div className="w-max">
      ...
      <div className="flex flex-col gap-1 rounded-[0.5625rem] bg-muted px-[0.81rem] py-[0.69rem] md:flex-row md:justify-between">
        <div className="flex items-center gap-[0.81rem]">
          ...
          <p className="text-base font-500">{t("status")}</p>
        </div>
      ...
      {qr_code_generation ? (
        ...
        <p className="rounded-[0.5625rem] bg-primary/10 p-2 text-foreground">
