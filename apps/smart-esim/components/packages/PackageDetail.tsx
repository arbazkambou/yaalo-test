...
function PackageDetail({ packageDetail, countryFlag }: PropsType) {
      ...
      <div className="grid gap-3 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-3.5">
        ...
        <PackageDetailItem>
          <div className="flex items-center gap-2">
            ...
            <p className="text-base font-500">{t("features.validity")}</p>
          </div>
          <p>
        ...
        <PackageDetailItem>
          <div className="flex items-center gap-2">
            ...
            <p className="text-base font-500">{t("features.speed")}</p>
          </div>
        ...
        <PackageDetailItem>
          <div className="flex items-center gap-2">
            ...
            <p className="text-base font-500">{t("features.tethering")}</p>
          </div>
        ...
        <div className="grid shrink-0 gap-4">
          ...
          {reshaped.length > 2 && (
            <div className="relative h-full w-full shrink-0">
              ...
              />
              <Search
                className="absolute top-1/2 -translate-y-1/2 transform text-primary"
                style={
                  isArabic
                ...
                <div className="flex flex-wrap gap-1" key={index}>
                  ...
                  {item.country_coverage.map((countrycoverages, index) => (
                    ...
                    >
                      ...
                      <p className="!rounded-full bg-primary text-background px-2">
