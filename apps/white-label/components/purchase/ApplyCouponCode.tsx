...
function ApplyCouponCode({
  ...
  return (
    <>
      ...
      >
        <CollapsibleTrigger className="flex w-full items-center justify-between transition-all hover:text-primary cursor-pointer">
          <p
          ...
          <ChevronDown
            size={20}
            className="transition-all text-foreground group-hover:text-primary group-data-[state=open]:rotate-180"
          />
        </CollapsibleTrigger>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormControl>
                      <Input
                        className={cn(inputStyle, "w-full text-foreground dark:bg-card")}
      ...
      {promoCodeData && (
        <div className="mb-3 flex items-center justify-between">
          ...
          <span
            className={cn(
              `flex items-center justify-center rounded-[6px] bg-primary/15 px-[12px] py-[4px] text-body-base font-medium text-primary`,
              discountTextStyle,
            )}
          >
