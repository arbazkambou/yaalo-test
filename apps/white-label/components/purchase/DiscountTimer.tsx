...
export function DiscountTimer() {
  ...
  return (
    <div className="flex items-center gap-4 p-4 rounded-2xl bg-grey/30 max-w-md shadow-sm">
      {/* Left Section */}
...
function TimeUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      ...
      <span className="text-foreground/60 text-body-sm font-medium uppercase mt-1">
        {label}
      </span>
    </div>
  );
