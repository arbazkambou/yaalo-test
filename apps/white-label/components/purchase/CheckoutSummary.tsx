...
function CheckoutSummary() {
  ...
  return (
    <>
      <>
        <div className="flex text-body-base font-500 text-foreground py-4 px-2 justify-between border-b border-grey/80">
          <p className="font-bold text-foreground text-lg">{t("payFromWallet")}</p>
          <p>${amount_deducted_from_wallet?.toFixed(2)}</p>
        </div>

        <div className="flex text-body-base font-500 text-foreground py-4 px-2 justify-between border-b border-grey/80 mb-4 ">
          <p className="font-bold text-foreground text-lg">{t("toPayOnCheckout")}</p>
