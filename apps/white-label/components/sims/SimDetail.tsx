  ...
  return (
    <Card className="flex flex-col gap-[3rem] rounded-[1.4rem] border border-primary px-[2rem] py-[2rem] shadow-none transition-all hover:shadow-myCard">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-end gap-[1.2rem]">
          <div className="flex flex-col gap-0.5">
            <p className="text-body-md text-foreground font-500 leading-none">
              {" "}
              {isICCIDNull ? t("simId") : t("iccid")}
            </p>
      ...
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex flex-col gap-0.5">
          <p className="text-body-md font-500 text-foreground leading-none">{t("status")}</p>
          <p className="text-body-md font-500 leading-none text-muted-foreground">
            {sim?.status}
          </p>
        </div>
      ...
      <div className="flex items-center gap-2.5">
        ...
        />
        <div className="flex flex-col gap-0.5">
          <p className="text-body-md text-foreground font-500 leading-none">{t("activatedBundle")}</p>
      ...
      <div className="flex items-end justify-between font-600 text-primary">
        <Link href={`/my-esims/${sim.id}`}>
          <Button
            ...
            className="flex items-center gap-2 rounded-full !py-3 transition-all bg-primary hover:text-background hover:bg-foreground text-foreground"
            size={"md"}
          >
