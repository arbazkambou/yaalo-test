...
export default function DataOnlyUsageChart({
  ...
  return (
    <Card className="rounded-[29px] px-[25px] py-[33px] shadow-md">
      <h2 className="text-center text-[26px] font-medium text-foreground">
        Data Usage
      </h2>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute mt-4 flex flex-col items-center">
            <div className="mb-2 flex items-center gap-2">
              ...
              <span className="text-body-base font-500 text-muted-foreground">
                {isUnlimitedData ? "Unlimited Data" : "Remaining Data"}
              </span>
            </div>
            {!isUnlimitedData && (
              <div className="flex items-center gap-2">
                <div className="rounded-md bg-primary p-1 text-xs text-foreground dark:text-background xs:px-2 xs:py-1 xs:text-body-base">
