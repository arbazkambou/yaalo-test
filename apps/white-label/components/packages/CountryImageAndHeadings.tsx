...
function CountryImageAndHeadings({
  ...
  return (
    <div className="relative w-full rounded-[2.5rem] xl:flex xl:h-[700px]">
      ...
      />
      <div className="absolute inset-0 hidden rounded-[2.5rem] bg-gradient-to-b from-black/80 via-black/40 to-transparent xl:block"></div>

      <div className="z-20 flex flex-col items-center justify-center gap-4 md:gap-6 xl:absolute xl:top-2 xl:text-background xl:opacity-95 dark:text-foreground">
        <div className="flex flex-col gap-4 rounded-[2.5rem] p-4 xl:rounded-b-none xl:rounded-t-[2.5rem]">
          <h1 className="flex flex-col items-center justify-center gap-6 text-body-xl font-600">
            {isDataVoice ? (
              <>
