...
const ShareableButton = ({
  ...
  return (
    <button
      ...
      className={cn(
        `flex cursor-pointer items-center gap-2 rounded-[0.3125rem] bg-muted px-[1rem] py-[0.62rem] text-body-sm font-500 text-foreground-light/85 transition-all hover:bg-primary hover:text-background xl:gap-[1rem]`,
        className,
      )}
    >
